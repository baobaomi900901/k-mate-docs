        ...
        (s = o.documentElement),
          ...
          b &&
            ...
            b.forEach((e) => {
              ...
              e._startClamp && t < 0
                ? ((r = e.ratio < 0 ? l.maxScroll() : e.end / e.ratio),
                  (o = r - e.end),
                  (t = 0))
                : (e.ratio < 0 || (e._endClamp && r >= l.maxScroll())) &&
                  ((r = l.maxScroll()),
                  (t =
                    e.ratio < 0 || e.ratio > 1
                      ? 0
            ...
            (o = y()),
              ...
              (u =
                g || (f && f._startClamp && f.start <= 0) || _.offset
                  ? 0
                  : f && f._endClamp && f.end === l.maxScroll()
                  ? 1
                  : 0.5),
              p && p.kill(),
              (p =
